...
export default function MarketsDemoPage() {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-50 flex flex-col font-sans select-none text-slate-700">
      ...
      {/* Toast Alert */}
      {toastMessage && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 z-50 bg-slate-900 text-white text-xs sm:text-sm font-medium py-2.5 px-5 rounded-full shadow-lg border border-slate-800 animate-bounce">
          {toastMessage}
        </div>
      )}
